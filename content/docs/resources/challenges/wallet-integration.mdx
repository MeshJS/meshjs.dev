  ...
  faqs={[
    {
      ...
      answer: "Cardano has multiple wallet providers (Eternl, Lace, Yoroi, etc.) with slight CIP-30 implementation differences. Unlike Ethereum's standardized window.ethereum, Cardano wallets register under different window.cardano properties, requiring detection and handling logic for each."
    },
    {
    ...
    },
    {
      ...
      answer: "Wallets inject themselves into window.cardano with their identifier (e.g., window.cardano.eternl, window.cardano.lace). Mesh SDK provides getInstalledWallets() to automatically detect all installed CIP-30 compatible wallets."
    },
    {
