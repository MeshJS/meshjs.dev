...
This guide builds a minting transaction, but the process applies to any transaction. <Link href="/apis/txbuilder">Learn more about Transaction</Link>.
...
Create a new MeshTxBuilder, loop through each recipient, and mint assets (<Link href="/apis/txbuilder/minting">Learn more about minting transactions</Link>):
