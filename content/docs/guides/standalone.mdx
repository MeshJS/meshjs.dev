...
2. Generate a wallet mnemonic using `MeshWallet.brew()` or use an existing one
...
- <Link href="/apis/wallets/meshwallet">Explore MeshWallet options</Link> - CLI keys, private keys, mnemonic
...
- <Link href="/apis/wallets/meshwallet">MeshWallet API</Link>
