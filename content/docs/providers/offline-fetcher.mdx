...
```tsx
import { OfflineFetcher, MeshTxBuilder, MeshWallet } from "@meshsdk/core";
...
async function testTransaction() {
  const wallet = new MeshWallet({
    ...
    key: {
      type: "mnemonic",
      words: ["test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test", "test"],
    },
  });
