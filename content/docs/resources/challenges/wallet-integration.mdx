...
<FAQSchema
  faqs={[
    ...
    },
    {
      ...
      answer: "Mesh provides getInstalledWallets() to automatically detect all installed CIP-30 compatible wallets without manual detection code."
    },
    {
