...
To interact with the blockchain, you'll need a wallet extension that supports the CIP30 standard. Choose and download one <Link href="https://developers.cardano.org/showcase/?tags=wallet">here</Link>.
...
Visit <Link href="http://localhost:3000">http://localhost:3000</Link> to view your application. Press **CTRL+C** to stop the server.
...
The source code for this lesson is available on <Link href="https://github.com/cardanobuilders/cardanobuilders.github.io/tree/main/codes/course-hello-cardano/02-multisig">GitHub</Link>.
