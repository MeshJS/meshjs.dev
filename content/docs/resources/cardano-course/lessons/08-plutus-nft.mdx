...
The code example above is presented in <Link href="https://github.com/MeshJS/mesh/tree/main/packages/mesh-contract/src/plutus-nft/aiken-workspace">Mesh repository</Link>, you can find the equivalent tests there.
...
The Plutus NFT contract has been implemented in `@meshsdk/contract` package, you can find further explanation at the <Link href="/smart-contracts/plutus-nft">Mesh documentation</Link> and more details about entire stack source code at <Link href="https://github.com/MeshJS/mesh/tree/main/packages/mesh-contract/src/plutus-nft">Mesh repository</Link>.