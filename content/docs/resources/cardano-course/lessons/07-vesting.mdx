...
We recommend you to check out <Link href="https://github.com/cardanobuilders/cardanobuilders.github.io/blob/main/codes/course-hello-cardano/03-vesting/src/aiken-workspace/validators/vesting.ak">`vesting.ak`</Link> to learn more.
...
This command will generate a CIP-0057 Plutus blueprint, which you can find in <Link href="https://github.com/cardanobuilders/cardanobuilders.github.io/blob/main/codes/course-hello-cardano/03-vesting/src/aiken-workspace/plutus.json">`plutus.json`</Link>.
...
Example of a <Link href="https://preprod.cardanoscan.io/transaction/556f2bfcd447e146509996343178c046b1b9ad4ac091a7a32f85ae206345e925">successful deposit transaction</Link>.
...
Example of a <Link href="https://preprod.cardanoscan.io/transaction/13d6b2258680bbdf08f50a3bbc03e7ed674f5614844ce773fc191c9582282b04">successful withdraw transaction</Link>.

## Source code

The source code for this lesson is available on <Link href="https://github.com/cardanobuilders/cardanobuilders.github.io/tree/main/codes/course-hello-cardano/03-vesting">GitHub</Link>.
