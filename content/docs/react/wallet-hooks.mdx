...
|----------|------|-------------|
| `wallet` | `BrowserWallet \| null` | Wallet instance with CIP-30 methods |
...
The `wallet` object is a [BrowserWallet](/apis/wallets/browserwallet) instance with full CIP-30 support:
...
**Solution:** Import types from `@meshsdk/core`:

```tsx
import type { BrowserWallet, Asset } from "@meshsdk/core";
import { useWallet, useAssets } from "@meshsdk/react";

const { wallet } = useWallet() as { wallet: BrowserWallet | null };
