...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'ada wallet integration',
    'cardano off-chain code',
    'cardano governance',
...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Open-source TypeScript SDK for building Cardano dApps, transactions, and smart contract interactions',
      publisher: {
        '@id': 'https://meshjs.dev/#organization',
      },
      inLanguage: 'en-US',
