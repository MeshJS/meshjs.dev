...
description: "Build Cardano transactions without wrestling with UTXOs, fees, or change calculation. Mesh SDK handles the complexity automatically."
---
...
**TL;DR:** MeshTxBuilder is a TypeScript blockchain SDK that simplifies Cardano transaction construction. Specify outputs, and Mesh automatically handles UTXO selection, fee calculation, and change management. Install with `npm install @meshsdk/core` and build production-ready transactions in minutes.

---

MeshTxBuilder solves the <Link href="/resources/challenges/utxo-model">UTXO complexity</Link> and <Link href="/resources/challenges/transaction-failures">transaction failure challenges</Link> that make Cardano dApp development difficult. This Cardano SDK handles the low-level details—UTXO selection, fee calculation, change outputs, minimum ADA requirements—so you describe what you want to send and Mesh figures out how. Stop debugging transaction construction and start shipping features.

## How Do I Build My First Cardano Transaction?
...
## What Features Does MeshTxBuilder Provide?

MeshTxBuilder provides comprehensive transaction capabilities for Cardano dApp development:
...
## What Are Common Transaction Patterns?
...
```typescript
// Send 10 ADA (10,000,000 lovelace) to recipient
...
### How Do I Send Native Tokens?

Transfer NFTs or fungible tokens:

```typescript
// Send 1 token with minimum required ADA (2 ADA)
const tx = await txBuilder
...
## Why Choose Mesh Transaction Builder?

### How Does Mesh Eliminate UTXO Complexity?
...
### How Does Mesh Prevent Common Errors?
...
### How Does Mesh Simplify Smart Contract Calls?

Interacting with Cardano smart contracts requires datums, redeemers, collateral, and script references. Mesh provides dedicated methods for each, making contract interaction as straightforward as simple transfers.

### How Does Mesh Handle Protocol Changes?
...
## What Are Advanced Transaction Patterns?

### How Do I Use Custom UTXO Selection?
...
### How Do I Set Validity Intervals?
...
### How Do I Require Additional Signers?
...
## How Do I Integrate with Wallets?

MeshTxBuilder works seamlessly with Mesh React blockchain components:
...
- <Link href="/resources/solutions/wallet-integration">Wallet Integration</Link>: Connect wallets to sign transactions
- <Link href="/resources/solutions/react-components">React Components</Link>: UI components for transaction interfaces
- <Link href="/resources/challenges/transaction-failures">Transaction Failures</Link>: Understanding why transactions fail
- <Link href="/resources/challenges/utxo-model">UTXO Model</Link>: Deep dive into Cardano's transaction model
- <Link href="/transactions">Transaction Documentation</Link>: Complete API reference
...
MeshTxBuilder handles the complexity of Cardano transactions so you can focus on your dApp logic. This TypeScript blockchain SDK lets you describe what you want to accomplish, and Mesh figures out how to make it happen—whether you're building JavaScript Web3 applications or production Cardano dApps.
