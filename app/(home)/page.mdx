...
<main className="min-h-screen">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-6">
            <Link
              href="https://github.com/MeshJS/skills"
            ...
            >
              <span>Browse on GitHub</span> <ArrowRight className="w-3 h-3" />
            </Link>
          </div>
        </div>

        <Card className="hover:border-foreground/20 transition-colors duration-150">
          <CardHeader>
  ...
  <section className="py-20 lg:py-28">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <Card className="hover:border-foreground/20 transition-colors duration-150 order-2 lg:order-1">
          <CardHeader>
            <div className="text-xs font-mono text-muted-foreground bg-muted rounded-md px-3 py-1.5 w-fit mb-4">
              connectWallet.tsx
            </div>
