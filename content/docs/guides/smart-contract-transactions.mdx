...
Build the transaction. Use MeshTxBuilder to redeem the UTxO and send the value back to the seller. Set required signers to the seller's address.
...
Build and submit the transaction. Use MeshTxBuilder to redeem the asset, transfer to the buyer, and pay the seller:
...
Build the transaction. Redeem the UTxO with the original datum and send the NFT to the script address with the new datum.
