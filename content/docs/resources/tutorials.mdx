...
<div className="grid md:grid-cols-2 gap-4 my-6">
  <Link href="/apis/transaction" className="no-underline">
    <Card className="h-full hover:border-primary/50 transition-colors">
      <CardHeader>
  ...
  <Link href="/apis/transaction/builder" className="no-underline">
    <Card className="h-full hover:border-primary/50 transition-colors">
      <CardHeader>
  ...
  <Link href="/apis/transaction/minting" className="no-underline">
    <Card className="h-full hover:border-primary/50 transition-colors">
      <CardHeader>
