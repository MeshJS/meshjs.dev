...
<Link href="https://blockfrost.io/">Blockfrost</Link> provides restful APIs which allows your app to access information stored on the blockchain.
...
const unsignedTx = await txBuilder
  .txOut('addr_test1vpvx0sacufuypa2k4sngk7q40zc5c4npl337uusdh64kv0c7e4cxr', [{ unit: 'lovelace', quantity: '5000000' }])
