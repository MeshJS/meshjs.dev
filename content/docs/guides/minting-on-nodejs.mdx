...
Create a new Transaction, loop through each recipient, and mint assets with **mintAsset** (<Link href="/apis/txbuilder/minting">Learn more about minting transactions</Link>):
