...
From lesson 3 to lesson 6, we will explore the core concepts of building Aiken smart contracts. Some materials are abstracted from <Link href="https://app.andamio.io/course/db22e013578fcead6c2fed5446d61891ad31f3cb4955e88d980107e7">Andamio's AikenPBL</Link>.
...
1. <Link href="https://aiken-lang.org/installation-instructions">Aiken Official Installation Guide</Link>
2. <Link href="https://app.andamio.io/course/db22e013578fcead6c2fed5446d61891ad31f3cb4955e88d980107e7/101/lesson/1">Andamio's AikenPBL Setup Guide</Link>
...
If you use VSCode as your IDE, install the <Link href="https://marketplace.visualstudio.com/items/?itemName=sidan-lab.cardano-bar-vscode">Cardano-Bar</Link> extension for code snippets to follow the course more easily.
...
To build Cardano validators, we need to understand how transactions work. Refer to the <Link href="https://aiken-lang.github.io/stdlib/cardano/transaction.html#Transaction">Aiken documentation</Link> for details on the `Transaction` structure.
...
Refer to <Link href="https://aiken-lang.github.io/stdlib/cardano/transaction.html#Input">Aiken documentation</Link> for types:
...
Refer to <Link href="https://aiken-lang.github.io/stdlib/cardano/script_context.html#ScriptContext">Aiken documentation</Link> for types of scripts in Cardano. Common types:
- **Minting**
- **Spending**
- **Withdrawing**
...
- Use `key_signed` from <Link href="https://github.com/sidan-lab/vodka">vodka</Link> for validation.
