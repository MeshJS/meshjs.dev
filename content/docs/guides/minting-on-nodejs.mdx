...
// Option 2: CLI keys (uncomment to use)
// const walletConfig = {
//   type: "cli" as const,
...
- <Link href="/apis/wallets/meshwallet">MeshWallet options</Link> - Different key types
...
- <Link href="/apis/wallets/meshwallet">MeshWallet Documentation</Link>
